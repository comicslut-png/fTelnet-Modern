...
1275 unit tests across 56 files, run on every commit. Phase boundaries:

  - End of Phase 1: 559 tests
  - End of Phase 2: 691 tests
  - End of Phase 3: 722 tests
  - End of Phase 4: 980 tests
  - Phase 5 (in progress): 1275 tests
...
npm test                 # run the full Vitest suite (1275 tests)
...
- `ftelnet.rip.xfer.js` — everything (~730 KB / ~158 KB gzipped)
